 ...
 * Declare programs 
 **/
extern CELL1 RES0__INSTANCE0;
extern UPDATE_PART RES0__INSTANCE1;

/***
 * Declare global variables from resources and conf 
 **/
extern __IEC_BOOL_t RES0__UPDATE_COMPLETE;
extern __IEC_DWORD_t RES0__PART_PROCESS;
extern       CELL1   RES0__INSTANCE0;
extern       UPDATE_PART   RES0__INSTANCE1;
...
{&(RES0__UPDATE_COMPLETE), BOOL_ENUM},
{&(RES0__PART_PROCESS), DWORD_ENUM},
{&(RES0__INSTANCE0.UPDATE_COMPLETE), BOOL_P_ENUM},
{&(RES0__INSTANCE0.PART_PROCESS), DWORD_P_ENUM},
{&(RES0__INSTANCE0.PALLET_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.PART_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.CNC_PART_READY), BOOL_ENUM},
{&(RES0__INSTANCE0.ROBOT_READY), BOOL_ENUM},
{&(RES0__INSTANCE0.PART_ATCONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE0.RETRACT_STOPPER), BOOL_ENUM},
{&(RES0__INSTANCE0.DELIVER_PART), BOOL_ENUM},
{&(RES0__INSTANCE0.PALLET_ARRIVAL), BOOL_ENUM},
{&(RES0__INSTANCE0.UPDATE_PART_PROCESS), BOOL_ENUM},
{&(RES0__INSTANCE1.UPDATE_COMPLETE), BOOL_P_ENUM},
{&(RES0__INSTANCE1.PART_PROCESS), DWORD_P_ENUM},
{&(RES0__INSTANCE1.RFID_IO_COMPLETE), BOOL_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.EN), BOOL_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.ENO), BOOL_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.IN), BOOL_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.PT), TIME_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.Q), BOOL_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.ET), TIME_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.STATE), SINT_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.PREV_IN), BOOL_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.CURRENT_TIME), TIME_ENUM},
{&(RES0__INSTANCE1.IO_TIMER.START_TIME), TIME_ENUM}
};
